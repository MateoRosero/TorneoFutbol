...
public class TorneoFutbol {
    ...
    public TorneoFutbol(int numEquipos) {
        ...
        // Asignamos los equipos a los nodos
        asignarEquipos(raiz);
    }
    ...
    public String asignarNombreEquipo(String idEquipo, String nombre) {
        ...
        return ""+ nombre + "' asignado correctamente al " + idEquipo + ".";
    }
    ...
    public String jugarPartido(int idPartido, String nombreGanador, String resEq1, String resEq2) {
        ...
        if (resultado.contains("Resultado ingresado correctamente")) {
            ...
            if (esFinal(partido)) {
                resultado = nombreGanador + " Es el campeon del torneo";
            } else {
                resultado = nombreGanador + " gano el partido ";
            }
        }
        return resultado;
    }
